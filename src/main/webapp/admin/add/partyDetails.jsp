  ...
  <body class="m-10">
    ...
    <div class="body-container flex justify-between items-center mt-10 mx-14">
      ...
      <div class="right-side">
        <div class="container mx-auto">
          <h4 class="text-xl font-medium">Add Party Details</h4>
          <form
            class="form"
            action="addPartyDetails?currentUserId=${userDetail.userId}"
            method="post"
          >
            <div class="flex flex-col mt-3">
              ...
              <input
                ...
                required
              />
              <label for="partyName" class="font-md text-gray-700 pb-1"
                >Party Name</label
              >
              <input
                type="text"
