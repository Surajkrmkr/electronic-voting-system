              ...
              <tbody>
                <c:forEach var="election" items="${allElection}">
                  <tr class="border-b odd:bg-[#FFE7D7] even:bg-[#FFD7BC]">
                    ...
                    <td class="px-6 py-4 font-medium">
                      <c:choose>
                        <c:when test="${election.electionStatus}">
                          <button>
                            <a class="bg-[#ED7D2B] text-white font-medium text-sm py-1 px-3 rounded-lg shadow-sm" href="/declareResult?electionId=${election.electionId}">
                              Result
                            </a>
                          </button>
                        </c:when>
